...
# Get-GitHubSubClaimPrefix lives in the shared module: verify-g0.ps1 asks GitHub the
# same question, and two copies of that answer is the F50 defect (see MlsBootstrap.psm1).
