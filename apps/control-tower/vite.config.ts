 ...
 * so the LocalProvider's Ops tab can fetch cost_daily/telemetry_summary in
 * `vite dev` and `vite preview`. Dev/Sec tabs use committed fixtures and need
 * no server support. Missing files answer 404 with the generator command.
 */
