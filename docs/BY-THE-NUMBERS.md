...
- **58 security findings** (36 pre-publication, 22 more raised by the first live
  tenant bring-up and the first two real deployments, 2026-08-29/30), each with severity, `file:line`, an attack
